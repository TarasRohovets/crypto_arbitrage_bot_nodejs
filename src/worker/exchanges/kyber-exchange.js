...
class KyberExchange {
    ...
    KYBER_RATE_ADDRESS = '0x96b610046d63638d970e6243151311d8827d69a5';
    kyberRateContract = new this.web3.eth.Contract(this.KYBER_RATE_ABI, this.KYBER_RATE_ADDRESS);

}

export default KyberExchange;